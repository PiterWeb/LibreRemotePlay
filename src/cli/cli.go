...
func init() {
	...
	whipServerPort := flag.Uint("whipport", 8082, "Port used for WHIP Server")
	...
	config = configT{
		...
		whipServerPort: uint16(*whipServerPort),
	}
}
...
func (c configT) GetWhipServerPort() uint16 {
	return c.whipServerPort
}
